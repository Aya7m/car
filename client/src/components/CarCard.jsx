...
const CarCard = ({ car }) => {
  ...
  return (
    <div
      ...
      className="group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-300"
    >
      ...
      <div className="mt-4 grid grid-cols-2 gap-y-2 text-gray-600 mb-5 ml-2">
