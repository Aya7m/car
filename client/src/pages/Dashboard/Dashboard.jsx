      ...
      <div className="flex flex-wrap items-center gap-6 mb-8 w-full">
        ...
        <div>
          ...
          {Array.isArray(data.recentBookings) && data.recentBookings.map((booking, index) => (
            <div key={index} className="mt-4 flex items-center justify-between gap-10">
        ...
        {/* monthly revenue */}
        <div className="p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full md:max-w-sx">
